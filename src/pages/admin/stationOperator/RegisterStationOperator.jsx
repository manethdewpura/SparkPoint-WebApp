...
import { registerStationOperator } from "../../../services/stationoperator.service";
import Sidebar from "../../../components/Sidebar";

const RegisterStationOperator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await registerStationOperator(formData, stationId);
      setSuccess(
        `Station operator registered successfully! User ID: ${response.userId}`
      );
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Add a new operator for this charging station
              </p>
            </div>
          </div>
...
export default RegisterStationOperator;
